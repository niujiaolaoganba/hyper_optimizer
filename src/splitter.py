...
class HomedepotSplitter:
    ...
    def split(self):
        ...
        for trainInd, validInd in rs:
            ...
            self._check_split(dfTrain2, dfValid, "product_uid", "navie")
...
def main():
    ...
    splitter = HomedepotSplitter(dfTrain, dfTest, config.N_RUNS, config.RANDOM_SEED, verbose=True, plot=True,
                                 split_param=[0.5, 0.25, 0.5]) # tune these params to get a close distribution
    splitter.split()
